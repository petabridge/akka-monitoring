...
namespace Akka.Monitoring.PerformanceCounters.Demo
{
    ...
    class WorkerActor : ReceiveActor
    {
        ...
        {
            Context.System.Scheduler.ScheduleTellRepeatedly(0, 500, Self, "do work", Self);
            base.PreStart();
        }
    }
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            var registeredMonitor = ActorMonitoringExtension.RegisterMonitor(_system, new ActorPerformanceCountersMonitor());
